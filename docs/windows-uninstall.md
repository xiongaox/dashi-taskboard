# Uninstall Antigravity Taskboard on Windows

1. Quit Antigravity Taskboard from its system-tray menu.
2. Open **Settings > Apps > Installed apps**.
3. Find **Antigravity Taskboard**, open its menu, and select **Uninstall**.
...
To remove that retained data, close Antigravity Taskboard and delete these directories
for the current Windows user:

- `%APPDATA%\Antigravity Taskboard`
- `%LOCALAPPDATA%\Antigravity Taskboard`
